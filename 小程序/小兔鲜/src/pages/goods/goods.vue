...
// uni-ui弹出层，当组件挂载完毕，会自动把组件实例保存到这个变量里
const popup = ref<{
  open: (type?: UniHelper.UniPopupType) => void
  close: () => void
}>()
const popupName = ref<'address' | 'service'>() // 弹出层渲染条件
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="detail panel">
      ...
      <view class="content">
        ...
        <!-- 图片详情 -->
        <image mode="widthFix" v-for="item in goods?.details.pictures" :src="item" :key="item" />
      </view>
    </view>
    <!-- 同类推荐 -->
