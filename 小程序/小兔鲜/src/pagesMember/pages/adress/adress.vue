...
const onChangeAddress = (item: AddressItem) => {
  ...
  store.changeSelectedAddress(item)
  uni.navigateBack()
}
</script>
...
<template>
  <view class="viewport">
          ...
          <uni-swipe-action-item class="item" v-for="item in addressList" :key="item.id">
            <view class="item-content" @tap="onChangeAddress(item)">
              ...
              <navigator
                ...
                hover-class="none"
                @tap.stop="() => {}"
                :url="`/pagesMember/pages/adress-form/adress-form?id=${item.id}`"
              >
                修改
              </navigator>
            </view>
    ...
    <view class="add-btn">
      <navigator hover-class="none" url="/pagesMember/pages/adress-form/adress-form">
        新建地址
      </navigator>
    </view>
  </view>
